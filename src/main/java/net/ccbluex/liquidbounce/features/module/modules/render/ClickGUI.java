...
public class ClickGUI extends Module {
    ...
    private static final IntegerValue colorRedValue = new IntegerValue("R", 65, 0, 255);
    private static final IntegerValue colorGreenValue = new IntegerValue("G", 215, 0, 255);
